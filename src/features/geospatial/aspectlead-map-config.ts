...
// AspectLead is a CLIENT of the independent @geospatial/map platform. This file is
...
import { createProductionSourceConfig, type GeospatialSourceConfig } from "@geospatial/map";
