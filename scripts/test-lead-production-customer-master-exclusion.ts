...
async function main() {
  ...
  const confirmedMateriality = assessCustomerMatchMateriality({ candidatePostcode: "RM1 1AA", candidateName: "Test Cafe", candidatePhone: null, candidateDomain: null, candidateCompanyNumber: "01234567", matchedCustomer: { postcode: "RM1 1AA", tradingName: "Test Cafe Ltd", phone: null, alternatePhones: [], domain: null, domains: [], companyNumber: "01234567" } });
  ...
  const probableMateriality = assessCustomerMatchMateriality({ candidatePostcode: "UB1 1AA", candidateName: "Curry Corner", candidatePhone: null, candidateDomain: null, candidateCompanyNumber: null, matchedCustomer: { postcode: "UB1 1AA", tradingName: "Curry Corner Express Kitchen", phone: null, alternatePhones: [], domain: null, domains: [], companyNumber: null } });
  ...
  const differentDistrict = assessCustomerMatchMateriality({ candidatePostcode: "RM1 1AA", candidateName: "Kebabish Original", candidatePhone: null, candidateDomain: null, candidateCompanyNumber: null, matchedCustomer: { postcode: "LU1 1EH", tradingName: "KEBABISH", phone: "01582483848", alternatePhones: [], domain: null, domains: [], companyNumber: null } });
