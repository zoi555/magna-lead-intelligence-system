...
export interface RowBundle { dossier: Dossier; resolved: ResolvedMasterRow; district: string }
...
export interface Buckets {
  ...
  // 2026-08-03: real gap found and fixed during campaign-002 live pilot verification —
  // evaluateBusinessCategoryEligibility() (business-category-eligibility.ts) was wired into
...
export function classify(rows: RowBundle[], registry: CommercialReviewRegistry, representative: string): Buckets {
